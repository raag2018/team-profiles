...
const agregarProfile = async(db, nombre, telefono, correo, github, linkedin, profilepic, profileproject, mensaje) => {
    try {
...
const expresiones = {
    ...
    mensaje: /^[a-zA-ZÀ-ÿ\s]{50,200}$/, // Letras y espacios, pueden llevar acentos.
}
const campos = {
    nombre: false,
    correo: false,
...
const validarFormulario = (e) => {
    switch (e.target.name) {
        ...
        case 'profileproject':
            ...
            break;
        case 'profileproject':
            validarCampo(expresiones.profileproject, e.target, 'mensaje');
            break;
    }
}
...
const agregar = () => {
    if (campos.nombre && campos.correo && campos.telefono && campos.github && campos.linkedin && campos.profilepic && campos.profileproject) {
        ...
        agregarProfile(db, nombre, telefono, correo, github, linkedin, profilepic, profileproject, mensaje);
        formulario.reset();
